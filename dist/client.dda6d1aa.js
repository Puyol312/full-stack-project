...
})({"2Smrz":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7944af86dda6d1aa";
"use strict";
...
},{}],"10tPJ":[function(require,module,exports,__globalThis) {
var _router = require("./router");
(function() {
    const root = document.querySelector("#root");
    root && (0, _router.initRouter)(root);
})();

},{"./router":"6r9TF"}],"6r9TF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initRouter", ()=>initRouter);
var _welcome = require("./pages/welcome");
var _nuevo = require("./pages/nuevo");
var _loby = require("./pages/loby");
var _sala = require("./pages/sala");
var _rules = require("./pages/rules");
var _playground = require("./pages/playground");
...
var routes = [
    ...
    {
        path: /\/nuevo-juego/,
        component: (0, _nuevo.initNuevo)
    },
    {
        path: /\/loby/,
        component: (0, _loby.initLoby)
    },
    {
        path: /\/salas/,
        component: (0, _sala.initSala)
    },
    {
        path: /\/rules/,
    ...
    {
        path: /\/playground/,
        component: (0, _playground.initPlayground)
    },
    {
        path: /\/game/,
        component: (0, _game.initGame)
    },
    {
        path: /\/result/,
...
function initRouter(container) {
    ...
    function handleRoute(route) {
        ...
        if (!found) goTo("/welcome");
    }
    if (getCurrentPath() == "/") goTo("/welcome");
    else handleRoute(getCurrentPath());
...
},{"./pages/welcome":"8GgR2","./pages/nuevo":"aeyau","./pages/loby":"bK0DN","./pages/sala":"26N3V","./pages/rules":"hePbA","./pages/playground":"4Arp7","./pages/game":"gDdmj","./pages/result":"bA5KG","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8GgR2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initWelcome(router) {
    const state = (0, _state.State).getInstance();
  ...
  `;
    div.querySelector("#NuevoJuego")?.addEventListener('click', ()=>{
        if (state.getUser() === null) router.goTo('/nuevo-juego');
        else if (state.getHistory().roomId) router.goTo('/loby');
        else {
...
},{"../../components/hands/hands":"5UPVf","../../components/button/button":"iC4An","./welcome.css":"9SXJQ","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5UPVf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HandsEl", ()=>HandsEl);
var _handTs = require("../hand/hand.ts");
...
class HandsEl extends HTMLElement {
    ...
    selectedHand(election) {
        ...
        (0, _stateTs.State).getInstance().setMove(election);
    }
}
customElements.define("multi-hand", HandsEl);

},{"../hand/hand.ts":"97WMM","../../state.ts":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"97WMM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Hand", ()=>Hand);
const piedraPNG = new URL(require("4c86f10f2f328005")).href;
const papelPNG = new URL(require("1c6c31e4ad88c65c")).href;
const tijeraPNG = new URL(require("7297b4854acd6994")).href;
...
},{"4c86f10f2f328005":"5qDEn","1c6c31e4ad88c65c":"adC6g","7297b4854acd6994":"5ImvG","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5qDEn":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("piedra.a8014940.png") + "?" + Date.now();

},{}],"adC6g":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("papel.f32694f0.png") + "?" + Date.now();

},{}],"5ImvG":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tijera.0232da40.png") + "?" + Date.now();
...
},{}],"dwmEe":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "State", ()=>State);
parcelHelpers.export(exports, "Resultado", ()=>Resultado);
var _database = require("firebase/database");
var _rtdb = require("./rtdb");
//@ts-ignore
const apiUrl = "http://localhost:8080" ?? "http://localhost:8080";
var Resultado = /*#__PURE__*/ function(Resultado) {
    Resultado[Resultado["ganar"] = 0] = "ganar";
    Resultado[Resultado["perder"] = 1] = "perder";
    Resultado[Resultado["empatar"] = 2] = "empatar";
    return Resultado;
}(Resultado || {});
class State {
    static instance;
    ...
    setUser(nombre, create) {
        fetch(apiUrl + "/users", {
            ...
            this.saveTosessionStorage();
            if (create) this.createSala(data.id);
            else this.notify();
        }).catch((error)=>{
    ...
    conectarRTDB(idCorto) {
        fetch(apiUrl + "/salas/" + this.user?.id + "?salaID=" + idCorto, {
            ...
            const roomRef = (0, _rtdb.ref)((0, _rtdb.database), 'salas/' + res.idLargo);
            (0, _database.get)(roomRef).then((snapshot)=>{
                if (snapshot.exists()) {
                    const data = snapshot.val();
                    if (data.owner === this.user?.id) {
                        this.currentGame.owner = true;
                        const oponenteRef = (0, _rtdb.ref)((0, _rtdb.database), 'salas/' + res.idLargo + '/currentGame/Jugador2');
                        (0, _rtdb.onValue)(oponenteRef, (snap)=>{
                            const data = snap.val();
                            this.escucharOponente(data);
                        });
                    } else {
                        const oponenteRef = (0, _rtdb.ref)((0, _rtdb.database), 'salas/' + res.idLargo + '/currentGame/Jugador1');
                        const jugadorRef = (0, _rtdb.ref)((0, _rtdb.database), 'salas/' + res.idLargo + '/currentGame/Jugador2');
                        this.history.roomId = idCorto;
                        (0, _database.update)(jugadorRef, {
                            name: this.user?.name,
                            id: this.user?.id,
                            online: true
                        });
                        (0, _database.get)(oponenteRef).then((snapShot)=>{
                            if (snapShot.exists()) {
    ...
    solveRules() {
        ...
        if (this.currentGame.game.myPlay) this.currentGame.game.myPlay = null;
    }
    esperarJugadaDelOponente() {
    ...
    whoWins(myPlay, computerPlay) {
        let res;
        if (myPlay === computerPlay) res = 2;
        else if (myPlay === "papel" && computerPlay === "tijera" || myPlay === "piedra" && computerPlay === "papel" || myPlay === "tijera" && computerPlay === "piedra") res = 1;
        else res = 0;
        return res;
    }
    subscribe(callback) {
...
},{"firebase/database":"eqXsT","./rtdb":"dCCUb","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eqXsT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
...
},{}],"clWgn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dCCUb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "database", ()=>database);
...
},{"@firebase/app":"clWgn","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iC4An":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ButtonEl", ()=>ButtonEl);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9SXJQ":[function() {},{}],"aeyau":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initNuevo", ()=>initNuevo);
var _hands = require("../../components/hands/hands");
var _button = require("../../components/button/button");
var _nuevoCss = require("./nuevo.css");
var _state = require("../../state");
function initNuevo(router) {
    const div = document.createElement("div");
  ...
  `;
    ...
    form?.addEventListener("submit", async function(event) {
        ...
        try {
            await (0, _state.State).getInstance().setUser(nombre, true);
            router.goTo("/loby");
        } catch (error) {
...
},{"../../components/hands/hands":"5UPVf","../../components/button/button":"iC4An","./nuevo.css":"fyNNI","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fyNNI":[function() {},{}],"bK0DN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initLoby", ()=>initLoby);
var _hands = require("../../components/hands/hands");
var _encabezado = require("../../components/encabezado/encabezado");
var _lobyCss = require("./loby.css");
var _state = require("../../state");
function initLoby(router) {
    const div = document.createElement("div");
    const state = (0, _state.State).getInstance();
  ...
  <!-- Mensaje de compartir c\xf3digo -->
  <h1>
    Comparti el c\xf3digo:<br>
  ...
  `;
    const updateRoomId = ()=>{
        const span = div.querySelector(".room-id");
        if (span) span.textContent = state.getHistory().roomId ?? "Esperando sala...";
    };
    div.querySelector("x-encabezado")?.addEventListener("sala-completa", (e)=>{
        const evento = e;
        router.goTo("/rules");
    });
...
},{"../../components/hands/hands":"5UPVf","../../components/encabezado/encabezado":"aCwoP","./loby.css":"5r7RQ","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aCwoP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Encabezado", ()=>Encabezado);
var _state = require("../../state");
class Encabezado extends HTMLElement {
    ...
    connectedCallback() {
        this.render();
        (0, _state.State).getInstance().subscribe(()=>{
            this.render();
        });
    }
    render() {
        ...
        for (const game of dataHistory){
            if (state.whoWins(game.myPlay, game.computerPlay) === (0, _state.Resultado).ganar) localScore++;
            else if (state.whoWins(game.myPlay, game.computerPlay) === (0, _state.Resultado).perder) oponentScore++;
        }
    ...
    `;
        ...
        this.shadow.appendChild(style);
        this.shadow.appendChild(div);
        if (localName && state.getHistory().oponent) this.dispatchEvent(new CustomEvent("sala-completa", {
            detail: {
                mensaje: "Esta la sala completa"
            },
            bubbles: true,
            composed: true
        }));
...
},{"../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5r7RQ":[function() {},{}],"26N3V":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initSala", ()=>initSala);
var _hands = require("../../components/hands/hands");
var _button = require("../../components/button/button");
var _salaCss = require("./sala.css");
var _state = require("../../state");
function initSala(router) {
    const state = (0, _state.State).getInstance();
    const div = document.createElement("div");
...
},{"../../components/hands/hands":"5UPVf","../../components/button/button":"iC4An","./sala.css":"5HgVd","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5HgVd":[function() {},{}],"hePbA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initRules(router) {
    ...
    div.innerHTML = `
      ...
      <mi-boton id="jugar" name="\xa1Jugar!"></mi-boton>
      <multi-hand></multi-hand>
  `;
    // State.getInstance().solveRules();
    div.querySelector("#jugar")?.addEventListener('click', ()=>{
        (0, _state.State).getInstance().aceptarReglas();
        if ((0, _state.State).getInstance().bothReady()) setTimeout(()=>{
            router.goTo('/game');
        }, 1000);
...
},{"../../components/button/button":"iC4An","../../components/hands/hands":"5UPVf","../../components/encabezado/encabezado":"aCwoP","./rules.css":"lRDVx","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lRDVx":[function() {},{}],"4Arp7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initPlayground", ()=>initPlayground);
var _hands = require("../../components/hands/hands");
var _encabezado = require("../../components/encabezado/encabezado");
var _playgroundCss = require("./playground.css");
var _state = require("../../state");
function initPlayground(router) {
    const state = (0, _state.State).getInstance();
    const div = document.createElement("div");
    div.classList.add("contenedor-rules");
    div.innerHTML = `
      <x-encabezado></x-encabezado>
      <div class="contenedor-rules-texto">
        <p>Esperando a que ${state.getHistory().oponent} presione \xa1Jugar!...</p>
      </div>
      <multi-hand></multi-hand>
  `;
    if (state.bothReady()) router.goTo("/game");
    else {
        const callbackPlay = ()=>{
            if (state.bothReady()) {
                state.setA();
...
},{"../../components/hands/hands":"5UPVf","../../components/encabezado/encabezado":"aCwoP","./playground.css":"5wHu7","../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5wHu7":[function() {},{}],"gDdmj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initGame", ()=>initGame);
var _hands = require("../../components/hands/hands");
var _count = require("../../components/count/count");
var _gameCss = require("./game.css");
var _state = require("../../state");
var _aleatorySelection = require("../../utils/aleatorySelection");
function initGame(router) {
    const state = (0, _state.State).getInstance();
    const div = document.createElement("div");
...
},{"../../components/hands/hands":"5UPVf","../../components/count/count":"7KVMQ","./game.css":"aFjth","../../state":"dwmEe","../../utils/aleatorySelection":"lQN38","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7KVMQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CircleCountdown", ()=>CircleCountdown);
var _state = require("../../state");
class CircleCountdown extends HTMLElement {
    ...
    `;
        (0, _state.State).getInstance().subscribe(()=>{
            if ((0, _state.State).getInstance().getState().myPlay) this.stop();
        });
    }
}
customElements.define("circle-countdown", CircleCountdown);

},{"../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aFjth":[function() {},{}],"lQN38":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "aleatorySelection", ()=>aleatorySelection);
function aleatorySelection() {
    const opciones = [
        "piedra",
        "papel",
        "tijera"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bA5KG":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initResult", ()=>initResult);
var _resultCss = require("./result.css");
var _state = require("../../state");
var _hand = require("../../components/hand/hand");
var _star = require("../../components/star/star");
var _button = require("../../components/button/button");
var _score = require("../../components/score/score");
function initResult(router) {
    const state = (0, _state.State).getInstance();
  ...
  `;
    setTimeout(()=>{
        ...
        const type = resultado == (0, _state.Resultado).ganar ? "win" : resultado == (0, _state.Resultado).perder ? "lose" : "draw";
        div.insertAdjacentHTML("beforeend", `
      <div class="result ${type}">
        <div class="star-container"><mi-star type=${type}></mi-star></div>
        <score-box></score-box>
        <mi-boton id="volverAjugar" name="\xa1Volver a Jugar!"></mi-boton>
      </div>
      `);
...
},{"./result.css":"3sIdg","../../state":"dwmEe","../../components/hand/hand":"97WMM","../../components/star/star":"5Xx59","../../components/button/button":"iC4An","../../components/score/score":"53iJy","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3sIdg":[function() {},{}],"5Xx59":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "StarEl", ()=>StarEl);
class StarEl extends HTMLElement {
    shadow = this.attachShadow({
        mode: "open"
    });
    constructor(){
    ...
    render() {
        ...
        const color = type === "win" ? "#6CB46C" : type === "lose" ? "#DC5B49" : "#999999";
        const style = document.createElement("style");
        const div = document.createElement("div");
    ...
    `;
        ...
        span.textContent = type === "win" ? "Ganaste" : type === "lose" ? "Perdiste" : "Empataste";
        const svg = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"53iJy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Score extends HTMLElement {
    ...
    render() {
        ...
        let computerScore = 0;
        for (const game of dataHistory){
            if (state.whoWins(game.myPlay, game.computerPlay) === (0, _state.Resultado).ganar) myScore++;
            else if (state.whoWins(game.myPlay, game.computerPlay) === (0, _state.Resultado).perder) computerScore++;
        }
        const div = document.createElement("div");
        const style = document.createElement("style");
        style.innerHTML = `
    ...
    `;
        ...
        div.innerHTML = `
    <h3>Score</h3>
    <p>${state.getUser()?.name}: ${myScore}</p>
    <p>${state.getHistory()?.oponent}: ${computerScore}</p>
    `;
        this.shadow.innerHTML = "";
        this.shadow.appendChild(style);
        this.shadow.appendChild(div);
...
},{"../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["2Smrz","10tPJ"], "10tPJ", "parcelRequire289a", {}, "./", "/")

//# sourceMappingURL=client.dda6d1aa.js.map
