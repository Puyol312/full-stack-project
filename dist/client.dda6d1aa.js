...
},{"./pages/welcome":"8GgR2","./pages/nuevo":"aeyau","./pages/loby":"bK0DN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./pages/sala":"26N3V","./pages/rules":"hePbA","./pages/playground":"4Arp7","./pages/game":"gDdmj","./pages/result":"bA5KG"}],"8GgR2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class State {
            ...
            (0, _database.get)(roomRef).then((snapshot)=>{
                if (snapshot.exists()) {
                    ...
                    if (data.owner === this.user?.id) {
                        ...
                        const jugadorRef = (0, _rtdb.ref)((0, _rtdb.database), 'salas/' + res.idLargo + '/currentGame/Jugador1');
                        (0, _rtdb.onValue)(oponenteRef, (snap)=>{
                            ...
                            if (data.choise !== false) this.getState().computerPlay = data.choise;
                        });
                    } else {
                        ...
                        (0, _rtdb.onValue)(oponenteRef, (snap)=>{
                            ...
                            if (dataOp.choise !== false) this.getState().computerPlay = dataOp.choise;
                        });
                    }
                }
                this.notify();
    ...
    setMove(myMove) {
        ...
        if (this.getState().computerPlay) this.notify();
    }
    setReady() {
        this.ready = false;
        fetch(apiUrl + "/salas/" + this.user?.id + "?salaID=" + this.history.roomId, {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./rtdb":"dCCUb","firebase/database":"eqXsT"}],"dCCUb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"iC4An":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../components/hands/hands":"5UPVf","./loby.css":"5r7RQ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../state":"dwmEe","../../components/encabezado/encabezado":"aCwoP"}],"5r7RQ":[function() {},{}],"aCwoP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../state":"dwmEe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"26N3V":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../components/hands/hands":"5UPVf","../../components/button/button":"iC4An","./sala.css":"5HgVd","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../state":"dwmEe"}],"5HgVd":[function() {},{}],"hePbA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initRules(router) {
  ...
  `;
    div.querySelector("mi-boton")?.addEventListener('click', ()=>{
        (0, _state.State).getInstance().iniciarJuego();
        router.goTo('/playground');
    });
    return div;
}

},{"../../components/button/button":"iC4An","../../components/hands/hands":"5UPVf","../../components/encabezado/encabezado":"aCwoP","./rules.css":"lRDVx","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../state":"dwmEe"}],"lRDVx":[function() {},{}],"4Arp7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initPlayground(router) {
    ...
    div.innerHTML = `
      <x-encabezado></x-encabezado>
      <div class="contenedor-rules-texto">
        <p>Esperando a que ${(0, _state.State).getInstance().getHistory().oponent} presione \xa1Jugar!...</p>
      </div>
      <multi-hand></multi-hand>
  `;
    if ((0, _state.State).getInstance().getReady()) router.goTo("/game");
    else (0, _state.State).getInstance().subscribe(()=>{
        if ((0, _state.State).getInstance().getReady()) router.goTo("/game");
    });
    return div;
}
...
function initGame(something) {
  ...
  `;
    ...
    el?.addEventListener("countdown-finished", (event)=>{
        ...
        (0, _state.State).getInstance().setMove((0, _aleatorySelection.aleatorySelection)());
    });
    return div;
}
...
function initResult(router) {
    const data = (0, _state.State).getInstance().getState();
    const div = document.createElement("div");
  ...
  `;
    setTimeout(()=>{
        ...
        const resultado = (0, _state.State).getInstance().whoWins(data.myPlay, data.computerPlay);
      ...
      `);
        ...
        boton?.addEventListener("click", (e)=>{
            e.stopPropagation();
            (0, _state.State).getInstance().setReady();
            setTimeout(()=>{
                router.goTo("./rules");
            });
        });
